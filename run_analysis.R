...
output_file <- paste(FILE_LOC, "/Getting_and_Cleaning_Data/mean_plus_sdev.csv", sep="")

write.csv(mean_sdev_dataset, file=output_file)

output_file <- paste(FILE_LOC, "/Getting_and_Cleaning_Data/summary_data.csv", sep="")

write.csv(summary_dataset, file=output_file)
